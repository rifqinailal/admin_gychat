...
class DetailGrupController extends GetxController {
  ...
  var groupDescription = 'Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document or a typeface without relying on meaningful content. This makes it easier to focus on the layout and design.'.obs; // <-- Deskripsi dibuat lebih panjang untuk demo
  ...
  var isDescriptionExpanded = false.obs; // <-- [BARU] State untuk expand/collapse deskripsi
  ...
  void goToEditInfoScreen() {
    ...
    Get.to(() => const EditDetailProfileGrupScreen());
  }
        ...
        child: Wrap(
          children: <Widget>[
            ListTile(
              ...
              title: const Text('Take Photo', style: TextStyle(color: Color(0xFF007AFF))),
              onTap: () {
                Get.back();
              },
            ),
            ListTile(
              ...
              title: const Text('Choose Photo', style: TextStyle(color: Color(0xFF007AFF))),
              onTap: () {
                Get.back();
